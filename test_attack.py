...
if len(trees_info) > 2:
    amostras_reconstruidas = attacker.phase_4(next_trees_indices=indices_arvores_subsequentes)
...
print(calcular_ra(np.concat([X_train, y_train.reshape(-1,1)], axis=1),amostras_reconstruidas_formatadas, [],))
